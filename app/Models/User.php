...
class User extends Authenticatable
{
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<MobileOffer, $this>
     */
    public function mobileOffers(): HasMany
    {
        return $this->hasMany(MobileOffer::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany<MobileOffer, $this, UserFavouritesMobileOffer>
     */
    public function favouriteMobileOffers(): BelongsToMany
    {
        return $this->belongsToMany(MobileOffer::class, 'user_favourites_mobile_offer');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany<User, $this, UserBlocksUser>
     */
    public function flagsMobileOffers(): BelongsToMany
    {
        return $this->belongsToMany(MobileOffer::class, 'user_flags_mobile_offer');
    }
