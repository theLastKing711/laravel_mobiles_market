...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cloudinary.cloud_name' => 'string',
            'cloudinary.api_key' => 'string',
            'cloudinary.api_secret' => 'string',
            'constants.local_week_days' => 'array',
            'constants.validation.user.ar.product.quantity.out_of_stock' => 'array',
            'constants.validation.user.en.product.quantity.out_of_stock' => 'array',
            'constants.resource_to_model.mobile_offers' => 'string',
            'constants.resource_to_model.users' => 'string',
            'constants.store_users_numbers' => 'array',
            'constants.storage_units' => 'array',
            'cors.paths' => 'array',
            ...
            'filesystems.links.C:\Users\beshe\OneDrive\Desktop\projects\used-mobiles-marketplace\laravel_mobiles_market\public\storage' => 'string',
            ...
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.0.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.0.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.1.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.1.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.2.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.2.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.3.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.3.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.4.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.4.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.5.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.5.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.6.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.6.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.7.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.7.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.7.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.8.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.8.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.8.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.9.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.9.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.9.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.10.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.10.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.11.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.11.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.11.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.12.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.12.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.12.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.13.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.13.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.13.optional' => 'boolean',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.14.name' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.fields.14.type' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.collection-schema.default_sorting_field' => 'string',
            'scout.typesense.model-settings.App\Models\MobileOffer.search-parameters.query_by' => 'string',
...
'cloudinary.cloud_name','cloudinary.api_key','cloudinary.api_secret','constants.local_week_days','constants.validation.user.ar.product.quantity.out_of_stock',
'constants.validation.user.en.product.quantity.out_of_stock','constants.resource_to_model.mobile_offers','constants.resource_to_model.users','constants.store_users_numbers','constants.storage_units',
...
'filesystems.disks.app.driver','filesystems.disks.app.root','filesystems.disks.app.throw','filesystems.disks.cloudinary.driver','filesystems.disks.cloudinary.key',
'filesystems.disks.cloudinary.secret','filesystems.disks.cloudinary.cloud','filesystems.disks.cloudinary.url','filesystems.disks.cloudinary.secure','filesystems.disks.cloudinary.prefix',
'filesystems.links.C:\\Users\\beshe\\OneDrive\\Desktop\\projects\\used-mobiles-marketplace\\laravel_mobiles_market\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'ide-helper.post_migrate','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'logging.channels.emergency.path','logging.channels.nightwatch.driver','logging.channels.nightwatch.via','logging.channels.nightwatch.level','logging.channels.deprecations.driver',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.0.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.1.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.2.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.2.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.3.name',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.3.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.4.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.4.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.5.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.5.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.6.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.6.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.optional',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.10.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.10.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.name',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.14.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.14.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.default_sorting_field',
'scout.typesense.model-settings.App\\Models\\MobileOffer.search-parameters.query_by','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except',
...
'role_or_permission','optional_auth',);
...
'livewire.upload-file','livewire.preview-file','files.cloudinary-presigned-urls','files.cloudinary-notifications-url','files.media.{public_id}',
'files.temporary-uploaded-image.{public_id}','users.auth.get-user-phone-number','users.auth.change-password',
'users.auth.change-phone-number','users.my-mobile-offers','users.my-mobile-offers.files.cloudinary-presigned-urls','users.my-mobile-offers.files.cloudinary-notifications-url','users.my-mobile-offers.files.media.{public_id}',
'users.my-mobile-offers.files.temporary-uploaded-image.{public_id}','users.my-mobile-offers.{id}.get','users.my-mobile-offers.post','users.my-mobile-offers.{id}.sold','users.my-mobile-offers.{id}.patch',
'users.my-mobile-offers.{id}.delete','users.mobile-offers.search','users.mobile-offers.favourites','users.mobile-offers.{id}','users.mobile-offers.{id}.favourite','users.auth.login.phone-number-step','users.auth.login.login','users.auth.registeration.phone-number-step','users.auth.registeration.register',
'storage.local','livewire.update',);
        registerArgumentsSet('views', 
'l5-swagger::index','pulse::dashboard','vendor.l5-swagger.index','vendor.pulse.dashboard','welcome',
...
'7224ff0b1fa42156c352216deff15b56::user-card','cloudinary::components.image','cloudinary::components.video','cloudinary::components.widget','l5-swagger::index',
...
'C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle','messages.users.my-mobile-offers.empty_number_of_images',
...
'validation.uppercase','validation.url','validation.ulid','validation.uuid','validation.custom.temporary_uploaded_images_ids.required',
'validation.attributes.name_in_english','validation.attributes.battery_health','validation.attributes.ram','validation.attributes.storage','validation.attributes.price_in_usd',
'enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_index','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_name','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_value','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enums.Spatie\\Enum\\Enumerable.slugged_name',
'enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enums.Spatie\\Enum\\Enumerable.slugged_other_name',);
...
'VITE_APP_NAME','CLOUDINARY_CLOUD_NAME','CLOUDINARY_KEY','CLOUDINARY_SECRET','CLOUDINARY_SECURE_URL',
'CLOUDINARY_URL','VITE_APP_NAME','ALGOLIA_APP_ID','ALGOLIA_API_KEY','SCOUT_DRIVER',
'TYPESENSE_API_KEY','TYPESENSE_HOST','LOG_SLACK_USERNAME','LOG_SLACK_WEBHOOK_URL','PULSE_DOMAIN',);
