...
'cloudinary.notification_url','cloudinary.cloud_name','cloudinary.cloud_url','cloudinary.api_key','cloudinary.api_secret',
'cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','constants.local_week_days','constants.validation.user.ar.product.quantity.out_of_stock',
'constants.validation.user.en.product.quantity.out_of_stock','constants.resource_to_model.mobile_offers','constants.resource_to_model.users','constants.store_users_numbers','cors.paths',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.app.driver',
'filesystems.disks.app.root','filesystems.disks.app.throw','filesystems.links.C:\\Users\\beshe\\OneDrive\\Desktop\\projects\\used-mobiles-marketplace\\laravel_mobiles_market\\public\\storage','ide-helper.filename','ide-helper.models_filename',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'logging.channels.nightwatch.level','logging.channels.deprecations.driver','logging.channels.deprecations.handler','mail.default','mail.mailers.smtp.transport',
...
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.0.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.1.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.2.name',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.2.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.3.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.3.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.4.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.4.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.5.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.5.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.6.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.6.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.name',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.7.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.8.optional',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.9.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.10.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.10.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.11.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.type',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.12.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.name','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.13.optional','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.14.name',
'scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.fields.14.type','scout.typesense.model-settings.App\\Models\\MobileOffer.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\MobileOffer.search-parameters.query_by','services.postmark.token','services.resend.key',
...
'typescript-transformer.writer','typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','debugbar.enabled',
...
'nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'livewire.pagination_theme','livewire.release_token','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'7224ff0b1fa42156c352216deff15b56::user-card','cloudinary::components.button','cloudinary::components.image','cloudinary::components.video','cloudinary::js',
...
'C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle','pagination.previous',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum',
'enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_index','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_name','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_value','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enums.Spatie\\Enum\\Enumerable.slugged_name','enum::C:.Users.beshe.OneDrive.Desktop.projects.used-mobiles-marketplace.laravel_mobiles_market.vendor.spatie.laravel-enum.resources.lang.en.validation.enums.Spatie\\Enum\\Enumerable.slugged_other_name',);
