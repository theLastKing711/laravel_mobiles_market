...
'livewire.upload-file','livewire.preview-file','files','files.media.{public_id}','files.temporary-uploaded-image.{public_id}',
'files.cloudinary-presigned-urls','files.cloudinary-notifications-url','users.auth.get-user-phone-number',
'users.auth.change-password','users.auth.change-phone-number','users.my-mobile-offers.files.cloudinary-presigned-urls','users.my-mobile-offers.files.cloudinary-notifications-url',
'users.my-mobile-offers.files.media.{public_id}','users.my-mobile-offers.files.temporary-uploaded-image.{public_id}','users.my-mobile-offers.{id}.get','users.my-mobile-offers','users.my-mobile-offers.{id}.sold',
'users.my-mobile-offers.{id}.patch','users.my-mobile-offers.{id}.delete','users.mobile-offers.search','users.mobile-offers.favourites','users.mobile-offers.{id}',
'users.mobile-offers.{id}.favourite','storage.local','livewire.update',);
